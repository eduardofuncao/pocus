...
var C = e.forwardRef((t2, n2) => {
  ...
  if (e.isValidElement(r2)) {
    const t3 = function(e2) {
      ...
      if (n3) return e2.ref;
      if (t4 = (_b = Object.getOwnPropertyDescriptor(e2, "ref")) == null ? void 0 : _b.get, n3 = t4 && "isReactWarning" in t4 && t4.isReactWarning, n3) return e2.props.ref;
...
var T = e.forwardRef((t2, n2) => {
  const { disableOutsidePointerEvents: r2 = false, onEscapeKeyDown: o2, onPointerDownOutside: i2, onFocusOutside: c2, onInteractOutside: u2, onDismiss: s2, ...l2 } = t2, f2 = e.useContext(L), [m2, v2] = e.useState(null), h2 = (m2 == null ? void 0 : m2.ownerDocument) ?? (globalThis == null ? void 0 : globalThis.document), [, g2] = e.useState({}), y2 = p(n2, (e2) => v2(e2)), E2 = Array.from(f2.layers), [w2] = [...f2.layersWithOutsidePointerEventsDisabled].slice(-1), C2 = E2.indexOf(w2), N2 = m2 ? E2.indexOf(m2) : -1, O2 = f2.layersWithOutsidePointerEventsDisabled.size > 0, x2 = N2 >= C2, T2 = function(t3, n3 = globalThis == null ? void 0 : globalThis.document) {
    ...
    return e.useEffect(() => {
      const e2 = (e3) => {
        ...
        } else n3.removeEventListener("click", i3.current);
        o3.current = false;
  ...
  return function(t3, n3 = globalThis == null ? void 0 : globalThis.document) {
    ...
    if (m2) return r2 && (0 === f2.layersWithOutsidePointerEventsDisabled.size && (k = h2.body.style.pointerEvents, h2.body.style.pointerEvents = "none"), f2.layersWithOutsidePointerEventsDisabled.add(m2)), f2.layers.add(m2), M(), () => {
...
e.forwardRef((t2, n2) => {
  ...
  return e.useEffect(() => {
    const e2 = o2.current;
    if (e2) return r2.branches.add(e2), () => {
  ...
  e.useEffect(() => {
    if (o2) {
      let e2 = function(e3) {
        ...
        if (document.activeElement === document.body) for (const t4 of e3) t4.removedNodes.length > 0 && U(s2);
      };
    ...
    if (s2) {
      ...
      if (!s2.contains(t3)) {
        ...
        s2.addEventListener(I, d2), s2.dispatchEvent(n3), n3.defaultPrevented || (!function(e3, { select: t4 = false } = {}) {
          ...
          for (const r3 of e3) if (U(r3, { select: t4 }), document.activeElement !== n4) return;
...
function B(e2, t2) {
  for (const n2 of e2) if (!$(n2, { upTo: t2 })) return n2;
}
function $(e2, { upTo: t2 }) {
  ...
  const { present: n2, children: r2 } = t2, o2 = function(t3) {
    ...
    return e.useEffect(() => {
      ...
      if (n4 !== t3) {
        ...
        if (t3) l2("MOUNT");
        else if ("none" === o4 || "none" === (e2 == null ? void 0 : e2.display)) l2("UNMOUNT");
        else {
    ...
    if (n3) return e2.ref;
    if (t3 = (_b = Object.getOwnPropertyDescriptor(e2, "ref")) == null ? void 0 : _b.get, n3 = t3 && "isReactWarning" in t3 && t3.isReactWarning, n3) return e2.props.ref;
    return e2.props.ref || e2.ref;
  }(i2));
...
var ne = function(t2) {
  var n2 = t2.sideCar, r2 = function(e2, t3) {
    var n3 = {};
    for (var r3 in e2) Object.prototype.hasOwnProperty.call(e2, r3) && t3.indexOf(r3) < 0 && (n3[r3] = e2[r3]);
    if (null != e2 && "function" == typeof Object.getOwnPropertySymbols) {
      var o3 = 0;
      for (r3 = Object.getOwnPropertySymbols(e2); o3 < r3.length; o3++) t3.indexOf(r3[o3]) < 0 && Object.prototype.propertyIsEnumerable.call(e2, r3[o3]) && (n3[r3[o3]] = e2[r3[o3]]);
    }
    return n3;
  }(t2, ["sideCar"]);
  if (!n2) throw new Error("Sidecar: please provide `sideCar` property to import the right car");
  var o2 = n2.read();
  if (!o2) throw new Error("Sidecar medium not found");
...
var de = function(e2) {
  if (void 0 === e2 && (e2 = "margin"), "undefined" == typeof window) return se;
  var t2 = function(e3) {
...
var Pe = (De = function(t2) {
  ...
  e.useEffect(function() {
    ...
    if (t2.inert) {
      ...
      var e2 = function(e3, t3, n3) {
        if (n3 || 2 === arguments.length) for (var r3, o3 = 0, i3 = t3.length; o3 < i3; o3++) !r3 && o3 in t3 || (r3 || (r3 = Array.prototype.slice.call(t3, 0, o3)), r3[o3] = t3[o3]);
  ...
  var u2 = e.useCallback(function(e2, t3) {
    if ("touches" in e2 && 2 === e2.touches.length) return !c2.current.allowPinchZoom;
    ...
    if ("touches" in e2 && "h" === d3 && "range" === l3.type) return false;
    var f3 = be(d3, l3);
    if (!f3) return true;
    if (f3 ? n3 = d3 : (n3 = "v" === d3 ? "h" : "v", f3 = be(d3, l3)), !f3) return false;
    if (!o2.current && "changedTouches" in e2 && (u3 || s3) && (o2.current = n3), !n3) return true;
    var p3 = o2.current || n3;
    return function(e3, t4, n4, r3, o3) {
      var i4 = /* @__PURE__ */ function(e4, t5) {
    ...
    if (ke.length && ke[ke.length - 1] === a2) {
      ...
      if (o3 && o3.should) t3.cancelable && t3.preventDefault();
      else if (!o3) {
...
var wt = (0, import_react.forwardRef)(function(e2, t2) {
  var n2 = e2.color, r2 = void 0 === n2 ? "currentColor" : n2, i2 = function(e3, t3) {
    ...
    for (r3 = 0; r3 < i3.length; r3++) n3 = i3[r3], t3.indexOf(n3) >= 0 || (o2[n3] = e3[n3]);
    return o2;
  }(e2, Et);
...
function Ot({ attachOnScroll: e2 = false, id: t2 = "prototypr", label: n2 = "Support me", color: r2 = "#00b9fe", textColor: o2 = "#fff" }) {
  ...
  return (0, import_react.useEffect)(() => {
    if ("undefined" != typeof window && !window.kofiWidgetOverlay) {
      if (e2) return window.addEventListener("scroll", a2, false), () => {
